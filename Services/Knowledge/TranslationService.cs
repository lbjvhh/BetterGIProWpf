...
public class TranslationService
{
    ...
    {
        try { if (Backend != null) return ApplyOfficialTerms(await Backend.TranslateAsync(text, from, to)); }
        catch { }
